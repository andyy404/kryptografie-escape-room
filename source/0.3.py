...
def room1():
    ...
    while True:
        ...
        if len(onscreen_corners) == 1:
            if onscreen_corners[0].left < w/2:
                onscreen_corners[0].update(onscreen_corners[0].left, int(onscreen_corners[0].left/(w/2)*h/9*2), 1, int(h/9*5 + (1-(onscreen_corners[0].left)/(w/2))*h/9*4))
            else:
                onscreen_corners[0].update(onscreen_corners[0].left, int((w-onscreen_corners[0].left)/(w/2)*h/9*2), 1, int(h/9*5 + (1-(w-onscreen_corners[0].left)/(w/2))*h/9*4))
        ...
        if len(onscreen_corners) == 2:
            onscreen_corners[0].update(onscreen_corners[0].left, int(onscreen_corners[0].left/(w/2)*h/9*2), 1, int(h/9*5 + (1-(onscreen_corners[0].left)/(w/2))*h/9*4))
            onscreen_corners[1].update(onscreen_corners[1].left, int((w-onscreen_corners[1].left)/(w/2)*h/9*2), 1, int(h/9*5 + (1-(w-onscreen_corners[1].left)/(w/2))*h/9*4))
        ...
        for corner in onscreen_corners:
