    ...
    while True:
        ...
        if len(onscreen_corners) == 1:
            if onscreen_corners[0].left < w/2:
                onscreen_corners[0].update(onscreen_corners[0].left, int(onscreen_corners[0].left/(w/2)*h/3), 1, int(h/3 + onscreen_corners[0].left/(w/2)*h/3*2))
            else:
                onscreen_corners[0].update(onscreen_corners[0].left, int((w-onscreen_corners[0].left)/(w/2)*h/3), 1, int(h/3 + (w-onscreen_corners[0].left)/(w/2)*h/3*2))
