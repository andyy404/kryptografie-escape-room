...
%\makeglossaries
%\input{Glossar}                     % greift auf Glossar.tex zu, worin alle Glossareinträge definiert sind
...
\setlength{\logoBindung}{5.0mm}    % positive Länge schiebt grosses Logo nach rechts
\setlength{\bildBindung}{36.0mm}    % positive Länge schiebt linken Bildrand nach rechts
\def\maTitelfarbe{\color{black}}   % black; Liste weiterer Farben: http://www.math.harvard.edu/computing/latex/color.html
\def\maTitelbild{\BILDER weiss}
...
\include{Kryptografie}	        % Name des Files

\include{Spiel}	        % Name des Files
...
\BemerkungLoFig{Abbildungen ohne Quellenangaben wurden vom Autor selbst erstellt.}
\listoffigures
